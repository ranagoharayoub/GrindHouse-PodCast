            ...
            <div className='margin-cont'>
                ...
                <div className='otherPods-cont'>
                    ...
                    <div className='listen-subscribe'>
                        ...
                        <div className='podcast-name'>
                            ...
                            <div className='podcasters'>
                                <div className='red-box'></div>
                                <a href='https://anchor.fm/grindhouse-courthouse'><p>STITCHER</p></a>
                            </div>
                            <hr className='line-hr'></hr>
                            <div className='podcasters'>
                                <div className='red-box'></div>
                                <a href='https://feeds.redcircle.com/b596f9b0-0ee2-4f3f-b64c-cacfa05c44ed'><p>RSS</p></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='icon-cont'>
                    <div className='icon-center'>
                        <a href='https://twitter.com/GHCHPodcast'><img src='/twitter-icon.png' alt='twitter' height= '64px' ></img></a>
