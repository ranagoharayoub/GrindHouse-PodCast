    ...
    return (
        <div id="mc_embed_signup">
            <form onSubmit={()=>setemail(email)} 
                    action="https://grindhousecourthouse.us1.list-manage.com/subscribe/post?u=b293ee40817
                    a741fc1f622110&amp;id=27b06850b0" method="post" id="mc-embedded-subscribe-form"
